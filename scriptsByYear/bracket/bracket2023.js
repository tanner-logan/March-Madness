...
document.getElementById("magicbtn").addEventListener("click", function () {
	const mwest = [Kansas, Howard, Arkansas, Illinois, SaintMarys, VCU, UConn, Iona, TCU, Nevada, Gonzaga, GrandCanyon, Northwestern, BoiseSt, UCLA, UNCAsheville];
	const west = [Alabama, TexasAMCC, Maryland, WestVirginia, SanDiegoSt, ColOfCharleston, Virginia, Furman, Creighton, NCState, Baylor, UCSB, Missouri, UtahSt, Arizona, Princeton];
	const east = [Purdue, FDU, Memphis, FAU, Duke, OralRoberts, Tennessee, Louisiana, Kentucky, Providence, KansasSt, MontanaSt, MichiganSt, USC, Marquette, Vermont];
	const south = [Houston, NKentucky, Iowa, Auburn, Miami, Drake, Indiana, KentSt, IowaSt, Pittsburgh, Xavier, KennesawSt, TexasAM, PennSt, Texas, Colgate];
	let totalFouls = 0;
	...
	const checkWinner = (t1, t2) => {
		...
		} else if (team1FoulsPG > averageFoulsPG && team2FTPercentage > averageFTPercentage) {
